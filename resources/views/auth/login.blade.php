...
<body>
    ...
    <div class="flex min-h-full justify-center px-6 py-20 lg:px-8 bg-green-50">
        <div class="border border-gray-300 py-20 sm:px-32 px-8 rounded-xl shadow-lg bg-gray-50">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                <img class="mx-auto h-52 w-auto" src="{{ asset('img/logo_mastani.svg') }}" alt="Your Company">
                <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Masuk
                </h2>
            </div>
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-semibold text-hijau-primary hover:text-green-700">Forgot
                                    password?</a>
                            </div>
                        </div>
                        <div class="mt-2">
                    ...
                    <div class="flex items-center mb-4">
                        <input id="remember_me" type="checkbox" value="" name="remember_me"
                            class="w-4 h-4 text-hijau-primary bg-gray-300 border-gray-700 rounded focus:ring-hijau-primary dark:focus:ring-hijau-primary dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-600 dark:border-gray-800">
                    ...
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-hijau-primary px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Sign
                            in</button>
                    </div>
                </form>
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-500">
                    Belum punya akun?
                    <a href="/regist" class="font-semibold text-hijau-primary hover:text-green-700">Daftar Sekarang</a>
                </p>
            </div>
